...
/**
  * This exception is thrown when Enceladus REST API failed to communicate to an LDAP server.
  *
  ...
  */
final case class BadLdapHostException(private val message: String,
