...
// the file is copied from hadoop3.2.1, with just method org.apache.hadoop.io.nativeio.NativeIO.Windows.access changed
// locally to make the tests run on Windows 10
...
public class NativeIO {
  ...
  public static class Windows {
    ...
    public static boolean access(String path, AccessRight desiredAccess)
      ...
      return true; // workaround to make NativeIo work on Windows 10 https://www.programmersought.com/article/33926846559/
    }
