...
object S3FsUtilsTestJob {
  ...
  def main(args: Array[String]): Unit = {
    ...
    log.info("found version (1): "
      + s3utils.getLatestVersion("s3://euw1-ctodatadev-dev-bigdatarnd-s3-poc/superhero/publish", "2020-08-06"))

    log.info("found no version (0): "
      + s3utils.getLatestVersion("s3://euw1-ctodatadev-dev-bigdatarnd-s3-poc/aaa", "2020-08-06"))
