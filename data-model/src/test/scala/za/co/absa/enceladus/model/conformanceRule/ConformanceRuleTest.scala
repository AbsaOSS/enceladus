...
class ConformanceRuleTest extends WordSpec with Matchers {
  ...
  "MappingConformanceRule" should {
    ...
    val json = """{"_t":"MappingConformanceRule","order":5,"controlCheckpoint":true,"mappingTable":"country","mappingTableVersion":0,"attributeMappings":{"country_code":"country"},"targetAttribute":"country_name","outputColumn":"conformed_country","isNullSafe":false,"mappingTableFilter":null,"overrideMappintTableOwnFilter":false}"""
    assertSerDe(rule, json)
  }
