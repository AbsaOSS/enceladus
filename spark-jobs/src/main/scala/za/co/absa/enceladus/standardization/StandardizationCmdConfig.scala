 ...
 */
trait StandardizationCmdConfigT[StandardizationCmdConfigT] extends StandardizationConfig[StandardizationCmdConfigT]
  with JobCmdConfig[StandardizationCmdConfigT]
...
case class StandardizationCmdConfig(rawFormat: String = "xml",
  ...
  extends StandardizationCmdConfigT[StandardizationCmdConfig] {
...
object StandardizationCmdConfigT {

  def getCmdLineArguments(args: Array[String]): StandardizationCmdConfigT[StandardizationCmdConfig] = {
