 ...
 */
trait ConformanceCmdConfigT[T] extends ConformanceConfig[T] with JobCmdConfig[T]
...
case class ConformanceCmdConfig(datasetName: String = "",
  ...
  extends ConformanceCmdConfigT[ConformanceCmdConfig] {
...
object ConformanceCmdConfigT {
  val stepName = "Conformance"

  def getCmdLineArguments(args: Array[String]): ConformanceCmdConfigT[ConformanceCmdConfig] = {
